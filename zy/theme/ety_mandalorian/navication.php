...
<nav class="navbar fixed-top navbar-expand-lg navbar-white bg-white fixed-top">
  <div class="container">
	<h1 class="navbar-brand" class="logo">
		<?php echo latest("logo","logo",5, 25); ?>
	</h1>
	


	  <ul class="navbar-nav d-none d-lg-flex abc">
		<?php
		$sql = " select *
					from {$g5['menu_table']}
					where me_use = '1'
	...
	<div id="rightMenu" class='d-flex align-items-center'>
				<button class="navbar-toggler navbar-dark  navbar-toggler-right" style='display:block !important' type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">
					<span class="navbar-toggler-icon"></span>
				</button>
				<div class="collapse navbar-collapse position-absolute" style='top:100%; left:0; right:0; background:white' id="navbarResponsive" data-hover="dropdown" data-animations="fadeIn fadeIn fadeInUp fadeInRight">
	  <ul class="mobile_menu d-none">
		<?php
		$sql = " select *
					from {$g5['menu_table']}
					where me_use = '1'
